...
export const terapeutasOptions = [
  ...
  {
    value: "Comunicação Direta",
    description:
      "Permite que o terapeuta se comunique diretamente com o paciente ou responsável, facilitando o esclarecimento de dúvidas e o acompanhamento do tratamento.",
  },
  {
    value: "Biblioteca de Recursos",
    description:
      "Permite que o terapeuta acesse uma biblioteca de recursos, como artigos, vídeos e materiais de apoio, para auxiliar no tratamento do paciente.",
  },
];

export const paisOptions = [
  {
    value: "Acompanhamento em Tempo Real",
    description:
      "Permite que os pais ou responsáveis acompanhem o progresso do paciente em tempo real, recebendo atualizações sobre as sessões e as metas estabelecidas.",
  },
  {
  ...
  {
    value: "Dados Consolidados",
    description:
      "Permite que os pais ou responsáveis acessem dados consolidados sobre o progresso do paciente, facilitando a compreensão do tratamento.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Permite que os pais ou responsáveis acessem arquivos e documentos relacionados ao tratamento do paciente, como relatórios e materiais de apoio.",
  },
];
